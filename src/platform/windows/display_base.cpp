...
typedef enum _D3DKMT_GPU_PREFERENCE_QUERY_STATE {
  D3DKMT_GPU_PREFERENCE_STATE_UNINITIALIZED,  /// LOL
  D3DKMT_GPU_PREFERENCE_STATE_HIGH_PERFORMANCE,  /// LOL
  D3DKMT_GPU_PREFERENCE_STATE_MINIMUM_POWER,  /// LOL
  D3DKMT_GPU_PREFERENCE_STATE_UNSPECIFIED,  /// LOL
  D3DKMT_GPU_PREFERENCE_STATE_NOT_FOUND,  /// LOL
  D3DKMT_GPU_PREFERENCE_STATE_USER_SPECIFIED_GPU  /// LOL
...
namespace platf::dxgi {
  ...
  HRESULT
  __stdcall NtGdiDdDDICacheHybridQueryValueHook(D3DKMT_GPU_PREFERENCE_QUERY_STATE *gpuPreference) {
    *gpuPreference = D3DKMT_GPU_PREFERENCE_STATE_UNSPECIFIED;
    return S_OK;
  }
  ...
  display_base_t::init(const ::video::config_t &config, const std::string &display_name) {
    ...
    std::call_once(windows_cpp_once_flag, []() {
...

      {
        ...
        MH_CreateHookApi(L"win32u.dll", "NtGdiDdDDICacheHybridQueryValue", (void *) NtGdiDdDDICacheHybridQueryValueHook, nullptr);
